...
tree_file <- file.path(expr_dir, tree_file)
...
tree_left <- prune_tree(tree = tree, nodes = leaf_nodes_midline, method = "at")
...
tree_right <- prune_tree(tree = tree, nodes = leaf_nodes_midline, method = "at")
...
#Create an empty image for new labels
